...
function TopFilterTourList() {
  ...
  // Sample tour data
  const tours = [
    { id: 1, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-4.png" },
    { id: 2, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-3.png" },
    { id: 3, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-2.png" },
    { id: 4, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-10.jpg" },
    { id: 5, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-5.jpg" },
    { id: 6, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-6.jpg" },
    { id: 7, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-7.jpg" },
    { id: 8, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-8.jpg" },
    { id: 9, name: "Dusitd2 Samyan Bangkok", location: "Bangkok, Thailand", duration: "3 Days 2 Night", persons: "2 Person", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/package/package-9.jpg" },
  ];
          ...
          <div className="row g-4">
                  ...
                  <div className="price-range-slider">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="range-value">
                        <p className="pera">price: </p> <input type="text" id="amount" readOnly defaultValue="$0 - $1000" />
            ...
            <div className="col-xl-9">
              <div className="showing-result">
                <h4 className="title">Showing {tours.length} of {tours.length} Results</h4>
                <div className="d-flex gap-10 align-items-center">
              ...
              <div className="all-tour-list">
                <div className="row g-4">
                  {tours.map((tour) => (
                    <div key={tour.id} className="col-xl-4 col-lg-4 col-sm-6">
                      <div className="package-card">
                        <div className="package-img imgEffect4">
                          <Link to="/details-with-slider">
                            <img src={tour.image} alt="travello" />
                          </Link>
                        ...
                        <div className="package-content">
                          <h4 className="area-name">
                            <Link to="/details-with-slider">{tour.name}</Link>
                          </h4>
                          <div className="location">
                            <i className="ri-map-pin-line"></i>
                            <div className="name">{tour.location}</div>
                          </div>
                          <div className="packages-person">
                            <div className="count">
                              <i className="ri-time-line"></i>
                              <p className="pera">{tour.duration}</p>
                            </div>
                            <div className="count">
                              <i className="ri-user-line"></i>
                              <p className="pera">{tour.persons}</p>
                            </div>
                          </div>
                          <div className="price-review">
                            <div className="d-flex gap-10">
                              <p className="light-pera">From</p>
                              <p className="pera">{tour.price}</p>
                            </div>
                            <div className="rating">
                              <i className="ri-star-s-fill"></i>
                              <p className="pera">{tour.rating}</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default TopFilterTourList;
