...
function TopFilterHotelList() {
  ...
  // Sample hotel data
  const hotels = [
    { id: 1, name: "Sunny Sands | Miami Beach", location: "Miami, USA", pools: "2 Pools", bathrooms: "2 Bathrooms", beds: "3 Beds", persons: "4-6 Persons", price: "$50", priceUnit: "/person", rating: "4.8 (15 Reviews)", image: "/assets/images/new/hotel1.png" },
    { id: 2, name: "Mountain Escape | Swiss Alps", location: "Zermatt, Switzerland", pools: "4 Lifts", bathrooms: "2 Bathrooms", beds: "4 Beds", persons: "5-7 Persons", price: "$75", priceUnit: "/person", rating: "5 (30 Reviews)", image: "/assets/images/new/hotel2.png" },
    { id: 3, name: "Paradise Bay Villas | Bora Bora", location: "Bora Bora, French Polynesia", pools: "Private Pool", bathrooms: "3 Bathrooms", beds: "2 Beds", persons: "2-4 Persons", price: "$95", priceUnit: "/person", rating: "4.5 (18 Reviews)", image: "/assets/images/new/hotel3.png" },
    { id: 4, name: "Urban Oasis | Tokyo", location: "Tokyo, Japan", pools: "Rooftop Pool", bathrooms: "1 Bathroom", beds: "2 Beds", persons: "2-3 Persons", price: "$65", priceUnit: "/person", rating: "4.7 (22 Reviews)", image: "/assets/images/new/hotel1.png" },
    { id: 5, name: "Desert Retreat | Dubai", location: "Dubai, UAE", pools: "Infinity Pool", bathrooms: "2 Bathrooms", beds: "3 Beds", persons: "4-5 Persons", price: "$85", priceUnit: "/person", rating: "4.9 (25 Reviews)", image: "/assets/images/new/hotel2.png" },
    { id: 6, name: "Coastal Haven | Santorini", location: "Santorini, Greece", pools: "Private Pool", bathrooms: "2 Bathrooms", beds: "2 Beds", persons: "2-4 Persons", price: "$100", priceUnit: "/person", rating: "4.6 (20 Reviews)", image: "/assets/images/new/hotel3.png" },
  ];
          ...
          <div className="row g-4">
            ...
            <div className="col-xl-9">
              <div className="showing-result">
                <h4 className="title">Showing {hotels.length} of {hotels.length} Results</h4>
                <div className="d-flex gap-10 align-items-center">
              ...
              <div className="all-tour-list">
                <div className="row g-4">
                  {hotels.map((hotel) => (
                    <div key={hotel.id} className="col-xl-4 col-lg-4 col-sm-6">
                      <div className="hotel-card">
                        <div className="hotel-img imgEffect4">
                          <Link to="/details-with-slider">
                            <img src={hotel.image} alt="travello" />
                          </Link>
                          <div className="rating-badge-car">
                            <div className="rating">
                              <i className="ri-star-s-fill"></i>
                              <p className="pera">{hotel.rating}</p>
                            </div>
                          </div>
                        </div>
                        <div className="hotel-content">
                          <h4 className="area-name">
                            <Link to="/details-with-slider">{hotel.name}</Link>
                          </h4>
                          <div className="location">
                            <i className="ri-map-pin-line"></i>
                            <div className="name text-capitalize">{hotel.location}</div>
                          </div>
                          <div className="hotel-person">
                            <div className="count">
                              ...
                              <p className="pera">{hotel.pools}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-tools-fill"></i>
                              </div>
                              <p className="pera text-capitalize">{hotel.bathrooms}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-bus-2-line"></i>
                              </div>
                              <p className="pera text-capitalize">{hotel.beds}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-run-line"></i>
                              </div>
                              <p className="pera text-capitalize">{hotel.persons}</p>
                            </div>
                          </div>
                          <div className="cart-footer d-flex flex-wrap justify-content-between">
                            <div className="d-flex gap-6 align-items-center">
                              <p className="pera">{hotel.price}</p>
                              <p className="sub-pera text-12 text-capitalize">{hotel.priceUnit}</p>
                            </div>
                            <Link to="/details-with-slider" className="browse-btn">book now</Link>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default TopFilterHotelList;
