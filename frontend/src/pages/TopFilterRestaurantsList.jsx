...
function TopFilterRestaurantsList() {
  ...
  const Restaurants = [
    { id: 1, name: "Fast Food", location: "Bangkok, Thailand", price: "$95", originalPrice: "$120", badge: "Popular", rating: "4.7 (20 Reviews)", image: "/assets/images/new/restaurent1.png" },
    { id: 2, name: "Italian Cuisine", location: "Rome, Italy", price: "$150", originalPrice: "$200", badge: "New", rating: "4.9 (50 Reviews)", image: "/assets/images/new/restaurent2.png" },
    { id: 3, name: "Sushi Bar", location: "Tokyo, Japan", price: "$110", originalPrice: "$130", badge: "Featured", rating: "4.8 (35 Reviews)", image: "/assets/images/new/restaurent3.png" },
    { id: 4, name: "Seafood Delight", location: "Sydney, Australia", price: "$175", originalPrice: "$220", badge: "Trending", rating: "4.6 (18 Reviews)", image: "/assets/images/new/restaurent4.png" },
    { id: 5, name: "Bistro & Café", location: "Paris, France", price: "$85", originalPrice: "$100", badge: "Cozy", rating: "4.5 (25 Reviews)", image: "/assets/images/new/restaurent5.png" },
    { id: 6, name: "Steakhouse", location: "Texas, USA", price: "$120", originalPrice: "$140", badge: "Recommend", rating: "4.8 (30 Reviews)", image: "/assets/images/new/restaurent6.png" },
    { id: 7, name: "Street Eats", location: "Hanoi, Vietnam", price: "$50", originalPrice: "$60", badge: "Friendly", rating: "4.3 (15 Reviews)", image: "/assets/images/new/restaurent7.png" },
    { id: 8, name: "Fine Dining", location: "Dubai, UAE", price: "$300", originalPrice: "$350", badge: "Luxury", rating: "4.9 (40 Reviews)", image: "/assets/images/new/restaurent8.png" },
    { id: 9, name: "Fine Dining", location: "Dubai, UAE", price: "$300", originalPrice: "$350", badge: "Luxury", rating: "4.9 (40 Reviews)", image: "/assets/images/new/restaurent9.png" },
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(/assets/images/popularPackages/bannerRestaurant.png)',
      ...
      >
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 className="title wow fadeInUp" data-wow-delay="0.0s" style={{ color: '#ffffff' }}>Restaurants</h1>
            ...
            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.1s">
              <ul className="breadcrumb listing">
                ...
                <li className="breadcrumb-item single-list" aria-current="page">
                  <a href="javascript:void(0)" className="single active">Restaurant List</a>
                </li>
              </ul>
            </nav>
          </div>
          ...
          <div className="plan-section plan-shadow">
            ...
            <div className="select-dropdown-section">
              <div className="d-flex gap-10 align-items-center">
                ...
                <h4 className="select2-title">Restaurant Type</h4>
              </div>
              <select className="destination-dropdown">
            ...
            <div className="col-xl-3">
              <div className="search-filter-section">
                ...
                <div className="language-filter">
                  ...
                  <div className="offer-list">
                    {['English', 'Spanish', 'French', 'Bangla'].map((lang) => (
                      <div key={lang} className="d-flex align-items-center gap-12 mb-12">
                        <label className="checkbox-label">
                          <input className="checkbox-style" type="checkbox" value="remember" name="remember" />
                          <span className="checkmark-style"></span>
                        </label>
                        <div className="content">
                          <p className="pera">{lang}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="all-tour-list">
                <div className="row g-4">
                  {Restaurants.map((Restaurant) => (
                    <div key={Restaurant.id} className="col-xl-4 col-lg-4 col-sm-6">
                      <div className="restaurant-card">
                        <div className="restaurant-img imgEffect4">
                          <Link to="/restaurant-details-with-slider">
                            <img src={Restaurant.image} alt="travello" />
                          </Link>
                          <div className="image-badge-restaurant">
                            <p className="pera">{Restaurant.badge}</p>
                          </div>
                        </div>
                        <div className="restaurant-content">
                          <h4 className="area-name">
                            <Link to="/restaurant-details-with-slider">{Restaurant.name}</Link>
                          </h4>
                          <div className="location">
                            <i className="ri-map-pin-line"></i>
                            <div className="name">{Restaurant.location}</div>
                          </div>
                          <div className="price-review">
                            <div className="d-flex align-items-center gap-10">
                              <p className="pera">{Restaurant.price}</p>
                              <del className="pera text-paragraph text-16">{Restaurant.originalPrice}</del>
                            </div>
                            <div className="rating">
                              <i className="ri-star-s-fill"></i>
                              <p className="pera">{Restaurant.rating}</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default TopFilterRestaurantsList;
