...
function TopFilterTransportsList() {
  const [adults, setAdults] = useState(0);
  const [children, setChildren] = useState(0);
  const [infants, setInfants] = useState(0);
  const [displayedTotal, setDisplayedTotal] = useState(2); // Initial value matching HTML (shows "02")
  ...
  // Initialize user-result display on mount (matching HTML initial value "02")
  useEffect(() => {
    const userResultElement = document.querySelector('.user-result');
    if (userResultElement && displayedTotal > 0) {
      userResultElement.textContent = displayedTotal.toString().padStart(2, '0');
    }
  }, [displayedTotal]);

  // Initialize Select2 for destination dropdowns and sorting dropdown
  useEffect(() => {
    if (typeof window !== 'undefined' && window.$ && window.$.fn && window.$.fn.select2) {
      const initSelect2 = () => {
        // Initialize destination-dropdown with Select2
        const $dropdowns = window.$('.destination-dropdown');
        $dropdowns.each(function() {
          const $dropdown = window.$(this);
        ...
        // Initialize sorting dropdown with Select2 (matching HTML behavior)
        const $sortingSelect = window.$('.sorting-dropdown .select2');
        $sortingSelect.each(function() {
        ...
        // Click handler for select2-title to open Select2
        window.$('.select2-title').off('click.select2-open').on('click.select2-open', function() {
          const $select = window.$(this).closest('.select-dropdown-section').find('select');
      ...
      return () => {
        ...
        // Cleanup Select2
        try {
          window.$('.destination-dropdown').each(function() {
            const $dropdown = window.$(this);
            if ($dropdown.data('select2')) {
              $dropdown.select2('destroy');
            }
          });
          window.$('.sorting-dropdown .select2').each(function() {
            const $select = window.$(this);
            if ($select.data('select2')) {
              $select.select2('destroy');
            }
          });
          window.$('.select2-title').off('click.select2-open');
        } catch (e) {
  ...
  // Initialize Date Picker (matching HTML behavior)
  useEffect(() => {
    if (typeof window !== 'undefined' && window.$ && window.$.fn && window.$.fn.daterangepicker) {
      const initDatePicker = () => {
        // Initialize daterangepicker on .custom-date elements
        const $datePicker = window.$('.custom-date');
        if ($datePicker.length > 0 && !$datePicker.data('daterangepicker')) {
          $datePicker.daterangepicker();
          
          // Handle date selection - update date-result
          $datePicker.on('apply.daterangepicker', function(ev, picker) {
            const startDate = picker.startDate.format('DD-MM-YYYY');
            const $dateResult = window.$('.date-result');
      ...
      return () => {
        ...
        try {
          window.$('.custom-date').each(function() {
  ...
  useEffect(() => {
    ...
    timer = setTimeout(() => {
      // Click handler for user-picker-dropdown - toggles show class
      handleUserPickerDropdownClick = (event) => {
        setShowGuestPicker(prev => !prev);
        event.stopPropagation();
      };

      // Click handler for user-picker - stops propagation to prevent closing
      handleUserPickerClick = (event) => {
        event.stopPropagation();
      };

      // Document click handler - closes if clicking outside
      handleDocumentClick = (event) => {
        // Check if click is outside both user-picker and user-picker-dropdown
  ...
  const Transports = [
    { id: 1, name: "Apex Drive 4T", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "5 (20 Reviews)", image: "/assets/images/new/transports2.png" },
    { id: 2, name: "Velocity Luxe TLine", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "3 (20 Reviews)", image: "/assets/images/new/transports3.png" },
    { id: 3, name: "Prestige Dynamic X4", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "3.7 (20 Reviews)", image: "/assets/images/new/transports4.png" },
    { id: 4, name: "Nova Glide T4", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "4.2 (20 Reviews)", image: "/assets/images/new/transports5.png" },
    { id: 5, name: "Quattro Prime 4", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "3.1 (20 Reviews)", image: "/assets/images/new/transports6.png" },
    { id: 6, name: "Audi A4 TD Line", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "23 (20 Reviews)", image: "/assets/images/new/transports7.png" },
    { id: 7, name: "Turbo Axis Line", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "4.1 (20 Reviews)", image: "/assets/images/new/transports8.png" },
    { id: 8, name: "LuxeSphere 4", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/new/transports9.png" },
    { id: 9, name: "Cruze T Dynamic", location: "new south, Thailand", miles: "6542 Miles", transmission: "Automatic", trips: "120 Trip", seats: "4 Seat", price: "$95", rating: "4.7 (20 Reviews)", image: "/assets/images/new/transports10.png" },
  ];
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(/assets/images/popularPackages/bannerTransport.png)',
      ...
      >
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 className="title wow fadeInUp" data-wow-delay="0.0s" style={{ color: '#ffffff' }}>Transports</h1>
            ...
            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.1s">
              <ul className="breadcrumb listing">
                ...
                <li className="breadcrumb-item single-list" aria-current="page">
                  <a href="javascript:void(0)" className="single active">Transport List</a>
                </li>
              </ul>
            </nav>
          </div>
          ...
          <div className="plan-section plan-shadow">
            ...
            <div className="select-dropdown-section">
              <div className="d-flex gap-10 align-items-center">
                ...
                <h4 className="select2-title">Transport Type</h4>
              </div>
              <select className="destination-dropdown">
            ...
            >
              ...
              <div className="user-result">{displayedTotal > 0 ? displayedTotal.toString().padStart(2, '0') : ''}</div>
              <div 
              ...
              >
                ...
                <div className="btn-section">
                  <a 
                    ...
                    className="done-btn" 
                    onClick={(e) => {
                      // Update total quantity (matching HTML behavior - only called on Done click)
                      updateTotalQuantity();
                      setShowGuestPicker(false);
                      e.stopPropagation(); // Match HTML behavior
                    }}
                  >
                    Done
                  </a>
            ...
            <div className="sign-btn">
              <button className="btn-secondary-lg">Search Plan</button>
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="rating-filter">
                  ...
                  <div className="ratting-section">
                    {[1, 2, 3, 4, 5].map((rating) => (
                      <div key={rating} className="ratting-checkbox">
                        <input type="checkbox" id={`rating-${rating}`} defaultChecked={rating === 4} />
                        <div>
                          <span>
              ...
              <div className="all-tour-list">
                <div className="row g-4">
                  {Transports.map((transport) => (
                    <div key={transport.id} className="col-xl-4 col-lg-4 col-sm-6">
                      <div className="transports-card">
                        <div className="transports-img imgEffect4">
                          <Link to="/transports-details-with-slider">
                            <img src={transport.image} alt="travello" />
                          </Link>
                          <div className="rating-badge-car">
                            <div className="rating">
                              <i className="ri-star-s-fill"></i>
                              <p className="pera">{transport.rating}</p>
                            </div>
                          </div>
                        </div>
                        <div className="transports-content">
                          <h4 className="area-name">
                            <Link to="/transports-details-with-slider">{transport.name}</Link>
                          </h4>
                          <div className="location">
                            <i className="ri-map-pin-line"></i>
                            <div className="name text-capitalize">{transport.location}</div>
                          </div>
                          <div className="transports-person">
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-speed-up-line"></i>
                              </div>
                              <p className="pera">{transport.miles}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-tools-fill"></i>
                              </div>
                              <p className="pera text-capitalize">{transport.transmission}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-bus-2-line"></i>
                              </div>
                              <p className="pera text-capitalize">{transport.trips}</p>
                            </div>
                            <div className="count">
                              <div className="icon text-primary">
                                <i className="ri-run-line"></i>
                              </div>
                              <p className="pera text-capitalize">{transport.seats}</p>
                            </div>
                          </div>
                          <div className="cart-footer d-flex flex-wrap justify-content-between">
                            <div className="d-flex gap-6 align-items-center">
                              <p className="pera">{transport.price}</p>
      ...
      {/*/ End-of Transport List */}
    </>
  );
}

export default TopFilterTransportsList;
